...
type Curve interface {
	...
	Sm2IsOnCurve(x, y *big.Int) bool
	// Add returns the sum of (x1,y1) and (x2,y2)
	Sm2Add(x1, y1, x2, y2 *big.Int) (x, y *big.Int)
	// Double returns 2*(x,y)
	Sm2Double(x1, y1 *big.Int) (x, y *big.Int)
	// ScalarMult returns k*(Bx,By) where k is a number in big-endian form.
	Sm2ScalarMult(x1, y1 *big.Int, k []byte) (x, y *big.Int)
	// ScalarBaseMult returns k*G, where G is the base point of the group
	// and k is an integer in big-endian form.
	Sm2ScalarBaseMult(k []byte) (x, y *big.Int)
}
...
func initP256Sm2() {
	...
	//2G
	//sm2P256.Gx, _ = new(big.Int).SetString("56CEFD60D7C87C000D58EF57FA73BA4D9C0DFA08C08A7331495C2E1DA3F2BD52", 16)
	//sm2P256.Gy, _ = new(big.Int).SetString("31B7E7E6CC8189F668535CE0F8EAF1BD6DE84C182F6C8E716F780D3A970A23C3", 16)
	//4G
	//sm2P256.Gx, _ = new(big.Int).SetString("C239507105C683242A81052FF641ED69009A084AD5CC937DB21646CD34A0CED5", 16)
	//sm2P256.Gy, _ = new(big.Int).SetString("B1BF7EC4080F3C8735F1294AC0DB19686BEE2E96AB8C71FB7A253666CB66E009", 16)
	//8G
	//sm2P256.Gx, _ = new(big.Int).SetString("B9C3FAEB4B1610713DB4333D4E860E64D4EA35D60C1C29BB675D822DED0BB916", 16)
	//sm2P256.Gy, _ = new(big.Int).SetString("C519B309ECF7269C2491D2DE9ACCF2BE0366A8A03024B3E03C286DA2CFD31A3E", 16)
	//16G
	//sm2P256.Gx, _ = new(big.Int).SetString("35648233F554AE51BBCE44EF5DB3E419EA133CD248A93E2555645BBC8704FB68", 16)
	//sm2P256.Gy, _ = new(big.Int).SetString("4D7AC60F6D975EF6117BCA9CE885DD6154B1870A6A651664411A9A30ECA2046", 16)
	//32G
	//sm2P256.Gx, _ = new(big.Int).SetString("25D3DEBD0950D180A6D5C2B5817F2329791734CD03E5565CA32641E56024666C", 16)
	//sm2P256.Gy, _ = new(big.Int).SetString("92D99A70679D61EFB938C406DD5CB0E10458895120E208B4D39E100303FA10A2", 16)
...
func (curve *Sm2P256Curve) Params() *Sm2P256Curve {
	return curve
}
/*xuxu*/
func (curve *Sm2P256Curve) ComputeY2(X *big.Int) (*big.Int, error) {
	//// Compute x^2
	//x3p7 := bn.Multiply(x, x)
	//x3p7 = bn.Mod(x3p7, CURVE.Params().P)
	//// Compute x^3
	...
	//x3p7 = bn.Mod(x3p7, CURVE.Params().P)
	//return x3p7, nil
	var a, x, x3 sm2P256FieldElement
	...
	return sm2P256ToBig(&x3),nil

}
// y^2 = x^3 + ax + b
func (curve *Sm2P256Curve) Sm2IsOnCurve(X, Y *big.Int) bool {
...
func (curve *Sm2P256Curve) Sm2Add(x1, y1, x2, y2 *big.Int) (*big.Int, *big.Int) {
...
func (curve *Sm2P256Curve) Sm2Double(x1, y1 *big.Int) (*big.Int, *big.Int) {
...
func (curve *Sm2P256Curve) Sm2ScalarMult(x1, y1 *big.Int, k []byte) (*big.Int, *big.Int) {
...
func (curve *Sm2P256Curve) Sm2ScalarBaseMult(k []byte) (*big.Int, *big.Int) {
	var scalarReversed [32]byte
